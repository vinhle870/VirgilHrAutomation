  ...
  () => {
    test(
      ...
      async ({ apiClient, authenticationService, adminPortalService }) => {
        ...
        await test.step("Pre-condition: Resolve department, plan, product types, and partner payload", async () => {
    ...
    test(
      ...
      async ({ apiClient, authenticationService, adminPortalService }) => {
        ...
        await test.step("Pre-condition: Resolve department, plan, and product types", async () => {
          const testData = new TestDataProvider(adminPortalService);
        ...
        await test.step("Create PEO/Consultant partner and verify level is 1", async () => {
        ...
        await test.step("Create Partner-level partner and verify level is 0", async () => {
    ...
    test(
      ...
      async ({ apiClient, authenticationService, adminPortalService }) => {
        ...
        await test.step("With and without sub-domain: create partner and verify response", async () => {
          for (let i = 0; i < 2; i++) {
    ...
    test(
      ...
      async ({ apiClient, authenticationService, adminPortalService }) => {
        ...
        await test.step("Payment options Partner vs Member Portal Consumer: create partner and verify paymentEnable", async () => {
    ...
    test(
      ...
      async ({ apiClient, authenticationService, adminPortalService }) => {
        ...
        await test.step("Pre-condition: Create partner (Partner/Consultant Owner)", async () => {
          const testData = new TestDataProvider(adminPortalService);
    ...
    test(
      ...
      async ({ apiClient, authenticationService, adminPortalService, memberPortalService }) => {
        ...
        await test.step("Activate account and obtain Member Portal token", async () => {
          await authenticationService.resetPasswordWithoutToken({ username: email, password: tempPassword }, undefined, "5");
        ...
        await test.step("Compare Admin Portal plan benefits with Member Portal subscription", async () => {
    ...
    test(
      ...
      async ({ apiClient, authenticationService, adminPortalService }) => {
        ...
        await test.step("Pre-condition: Resolve department, plan, product types, and partner payload (Product Type field)", async () => {
          const testData = new TestDataProvider(adminPortalService);
    ...
    test(
      ...
      async ({ apiClient, authenticationService, adminPortalService }) => {
        ...
        await test.step("Activate credentials and obtain Partner Portal and Member Portal tokens", async () => {
          await authenticationService.resetPasswordWithoutToken({ username: email, password: tempPassword }, undefined, "5");
    ...
    test(
      ...
      async ({ apiClient, authenticationService }) => {
        ...
        await test.step("Pre-condition: Create partner (Member Portal Consumer)", async () => {
    ...
    test(
      ...
      async ({ apiClient, authenticationService }) => {
        ...
        await test.step("Activate account and verify Partner Portal token", async () => {
          await authenticationService.resetPasswordWithoutToken({ username: email, password: tempPassword }, undefined, "5");
