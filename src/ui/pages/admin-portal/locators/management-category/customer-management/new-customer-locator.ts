export class CreateNewCustomerModalLocator {
  ...
  public static readonly companyName =
    "xpath=//span[text()='Company Name']/parent::label/following-sibling::div/div/input";
  ...
  public static readonly contactNumber =
    "xpath=//span[text()='Contact Number']/parent::label/following-sibling::div//input[@maxlength='25']";
  public static readonly department =
    "xpath=//span[text()='Contact Number']/ancestor::div[@class='col-6']/following-sibling::div[@class='col-12']//span[text()='Department']/parent::label/following-sibling::div//input";
  public static readonly officialSubscription =
    "xpath=//span[text()='Subscription Type']/parent::label/following-sibling::div//span[contains(text(), 'Official Subscription ')]";
  public static readonly freeTrial =
    "xpath=//span[text()='Subscription Type']/parent::label/following-sibling::div//span[contains(text(), 'Free Trial')]";
  public static readonly bankTranfer =
    "xpath=//span[text()='Bank Transfer']/parent::label/following-sibling::div//span]";
  public static readonly companySize =
  ...
  public static readonly internal =
    "xpath=//span[text()='User Type']/parent::label/following-sibling::div//span[contains(text(),'Internal')]";
  public static readonly business =
    "xpath=//span[text()='Business Type']/parent::label/following-sibling::div//span[contains(text(),'Business')]";
  public static readonly consultant =
    "xpath=//span[text()='Business Type']/parent::label/following-sibling::div//span[contains(text(),'Consultant')]";
