...
export class LeftMenu {
    ...
    async validateDisplayedMenuContainText(value: string) {
        ...
        const menuItems = await LocatorHandling.getLocator(this.page, LeftMenuLocators.ul_menuItems);
    ...
    async searchForMenuWithText(value: string) {
        ...
        const searchField = await LocatorHandling.getLocator(this.page, LeftMenuLocators.txt_search);
